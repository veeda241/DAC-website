...
const Loader: React.FC<LoaderProps> = ({ placeholderSrc }) => {
    ...
    return (
        <Html center>
            {placeholderSrc ? (
                ...
                <span style={{ color: '#fff', fontFamily: 'Inter, sans-serif' }}>{Math.round(progress)} %</span>
            )}
        </Html>
    );
};
...
const DesktopControls: React.FC<DesktopControlsProps> = ({ pivot, min, max, zoomEnabled }) => {
