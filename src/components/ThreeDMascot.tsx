...
const Model = ({ url }: { url: string }) => {
    ...
    return <primitive object={scene} ref={modelRef} scale={2.0} position={[0, -0.4, 0]} />;
};
...
const ThreeDMascot = () => {
    ...
    if (hasError) {
        return (
            <div className="relative w-full h-[600px] md:h-[800px] flex items-center justify-center group">
                ...
                <div className="relative z-10 animate-mascot-float">
                    ...
                    <img src={MASCOT_URL} alt="DAC Mascot" className="w-[400px] h-[400px] md:w-[600px] md:h-[600px] object-contain drop-shadow-[0_20px_50px_rgba(168,85,247,0.4)]" />
                </div>
            </div>
        );
    }
    ...
    if (USE_MODEL_VIEWER) {
        return (
            <div
                ...
                className="relative w-full aspect-square md:aspect-auto md:h-[850px] flex items-center justify-center group pointer-events-none"
            >
                ...
                <div className="relative z-10 w-full h-full max-w-[850px] max-h-[850px] pointer-events-auto">
                    <ModelViewer
                        url="/owl.glb"
                        width={"100%" as any}
                        height={"100%" as any}
    ...
    return (
        <div
            onMouseEnter={() => setIsHovered(true)}
            onMouseLeave={() => setIsHovered(false)}
            className="relative w-full h-[600px] md:h-[850px] cursor-grab active:cursor-grabbing group"
        >
